...
# Все темы для офлайн
OFFLINE_TOPICS = [
    ("родительство", ["Юлия Курчанова", "Александра Иванова"]),
    ("трудности в межличностных отношениях", ["Анастасия Дира", "Александра Иванова", "Лала Джагитян"]),
    ("я страдаю от насилия", ["Александра Иванова", "Анастасия Дира"]),
    ("Я — автор насилия", ["Александра Иванова", "Анастасия Дира"]),
    ("самооценка и самоценность", ["Анастасия Дира", "Александра Иванова", "Лала Джагитян", "Екатерина Бычкова"]),
    ("тревога и тревожные состояния", ["Анастасия Дира", "Александра Иванова"]),
    ("тяжелый кризис", ["Александра Иванова", "Анна Карманова", "Анастасия Дира"]),
    ("я потерял(а) близкого человека", ["Александра Иванова", "Анастасия Дира", "Лала Джагитян"]),
...
# Все темы для онлайн
ONLINE_TOPICS = [
    ("родительство", ["Юлия Курчанова", "Александра Иванова", "Армина Нерсесян"]),
    ("трудности в межличностных отношениях", ["Анастасия Дира", "Александра Иванова", "Лала Джагитян", "Армина Нерсесян", "Анастасия Блинова", "Вилена Васильева"]),
    ("я страдаю от насилия", ["Александра Иванова", "Анастасия Дира", "Армина Нерсесян"]),
    ("Я — автор насилия", ["Александра Иванова", "Анастасия Дира"]),
    ("самооценка и самоценность", ["Анастасия Дира", "Александра Иванова", "Лала Джагитян", "Екатерина Бычкова", "Анна Карманова", "Анастасия Блинова", "Вилена Васильева", "Армина Нерсесян"]),
    ("тревога и тревожные состояния", ["Анастасия Блинова", "Анастасия Дира", "Александра Иванова", "Армина Нерсесян", "Вилена Васильева"]),
    ("тяжелый кризис", ["Анастасия Блинова", "Александра Иванова", "Анна Карманова", "Армина Нерсесян", "Вилена Васильева"]),
    ("я потерял(а) близкого человека", ["Александра Иванова", "Анастасия Дира", "Лала Джагитян", "Армина Нерсесян"]),
    ("выгорание", ["Екатерина Бычкова"]),
